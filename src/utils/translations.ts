...
export const translations: Translations = {
  ...
  'toast.delete': { vi: 'Đã xóa', en: 'Deleted' },
  'toast.copy': { vi: 'Đã sao chép', en: 'Copied' },
  'toast.paste': { vi: 'Đã dán', en: 'Pasted' },
  'toast.duplicate': { vi: 'Đã nhân đôi', en: 'Duplicated' },
  'toast.drawing.saved': { vi: 'Đã lưu nét vẽ', en: 'Drawing saved' },
  'toast.erasing.saved': { vi: 'Đã lưu nét xóa', en: 'Erasing saved' },
